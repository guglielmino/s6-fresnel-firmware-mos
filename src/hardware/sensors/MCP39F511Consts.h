...
#define MCP_REG_OFFSET_CURRENT  0x0068 // Offset Calibration Factor for RMS Current
#define MCP_REG_OFFSET_AC_POWER 0x006C // Offset Calibration Factor for Active Power
#define MCP_REG_OFFSET_RE_POWER 0x0070 // Offset Calibration Factor for Reactive Power
